"""
A 4 classes room classifier on top of DenseNet169.
...
result_dir = 'four_classes/DenseNet169/'
...
def save_bottlebeck_features():
    ...
    # build the DenseNet169 network
    model = applications.DenseNet169(include_top=False, weights='imagenet')
